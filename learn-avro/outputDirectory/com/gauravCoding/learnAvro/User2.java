...
public class User2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3615475899789292732L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"User2\",\"namespace\":\"com.gauravCoding.learnAvro\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"favorite_number\",\"type\":[\"int\",\"null\"]},{\"name\":\"favorite_color\",\"type\":[\"string\",\"null\"]}]}");
   ...
   */
  public User2(java.lang.CharSequence name, java.lang.Integer favorite_number, java.lang.CharSequence favorite_color) {
    this.name = name;
   ...
   */
  public static com.gauravCoding.learnAvro.User2.Builder newBuilder() {
    return new com.gauravCoding.learnAvro.User2.Builder();
  }
   ...
   * @return A new User2 RecordBuilder
   */
  public static com.gauravCoding.learnAvro.User2.Builder newBuilder(com.gauravCoding.learnAvro.User2.Builder other) {
    if (other == null) {
      return new com.gauravCoding.learnAvro.User2.Builder();
    } else {
      return new com.gauravCoding.learnAvro.User2.Builder(other);
    }
  }
   ...
   * @return A new User2 RecordBuilder
   */
  public static com.gauravCoding.learnAvro.User2.Builder newBuilder(com.gauravCoding.learnAvro.User2 other) {
    if (other == null) {
      return new com.gauravCoding.learnAvro.User2.Builder();
    } else {
      return new com.gauravCoding.learnAvro.User2.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<User2>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.gauravCoding.learnAvro.User2.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.gauravCoding.learnAvro.User2 other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gauravCoding.learnAvro.User2.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gauravCoding.learnAvro.User2.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gauravCoding.learnAvro.User2.Builder setFavoriteNumber(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gauravCoding.learnAvro.User2.Builder clearFavoriteNumber() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gauravCoding.learnAvro.User2.Builder setFavoriteColor(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gauravCoding.learnAvro.User2.Builder clearFavoriteColor() {
      favorite_color = null;
